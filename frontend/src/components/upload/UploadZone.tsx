    ...
    isUploading && progress ? (
      ...
      <article
        ...
        className={`bg-green-3 rounded-full 
          ...
          flex cursor-pointer items-center justify-center border border-dashed border-green-4 transition-colors ${isDragActive ? 'bg-green-900' : ''
      ...
      >
        <section className="flex flex-col items-center space-y-1.75">
          ...
          <p className="font-imb-400 text-[10px] text-gray-2">Files automatically deleted after 3 days</p>
          <p className="font-imb-400 text-[10px] text-gray-2">Max Upload File: 1GB</p>
